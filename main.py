...
def extract_president_names(directory):
    ...
    Returns
    ----------
    str: A message with extracted president names  
    or
    ...
    if not os.path.exists(directory):
        ...
        if files_presidents:
            ...
            message = f"Here's the list of president available in our data base : {files_presidents}"
    return message
...
print(convert_text_cleaned("Nomination_Julien.txt","speeches", "cleaned"))
